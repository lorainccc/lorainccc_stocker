...
?>
    ...
    <div class="large-4 medium-4 columns"> <img class="footer-logo" src="http://sites.lorainccc.edu/stocker/wp-content/uploads/sites/4/2016/07/Stocker-Arts-Ctr-logo.svg" alt="LCCC Stocker Footer Logo" width="260" height="82.5"/>
    ...
    <div class="large-4 medium-4 columns">
      ...
      <ul class="underline">
        <li><a href="http://sites.lorainccc.edu/stocker/about-the-stocker-arts-center/map-and-directions-to-the-stocker-arts-center/" title="Map and Directions to LCCC">Map and Directions</a></li>
      </ul>
    </div>
    <div class="large-4 medium-4 columns">
      <h2>Quick Links</h2>
      <ul class="underline">
        <li><a href="http://www.lorainccc.edu" title="Visit LCCC's Home page">Lorain County Community College</a></li>
        <li><a href="http://sites.lorainccc.edu/stocker/wp-content/uploads/sites/4/2016/07/HokeTheatreSeatingChart7.21.16.pdf" title="View the Hoke Theatre Seating Chart">Hoke Theatre Seating Chart</a></li>
      </ul>
    </div>
  </div>
</footer><!-- #colophon -->
